...
\pagestyle{fancy}
\fancyhf{}
\lhead{2001.01.07: Troll Masters -- Gausdal NOR}
\rhead{Carlsen,Magnus vs. Fant,G -- 1-0 -- C16}
...
\chessboard[smallboard, setfen={rnbqk2r/p1p1nppp/1p2p3/3pP3/3P2Q1/P1P5/2P2PPP/R1B1KBNR b KQkq - 1 7},
             pgfstyle=border,
             color=YellowGreen,
             markfields={d1,g4}]
\newline
...
\hline
Carlsen,Magnus & Fant,G & Carlsen,Magnus & Fant,G \\
\hline
\endhead
